...
if (isset($_POST['name'])) {
    ...
    $sql = "insert into sinh_vien (name,lop_hoc_id,birthday,gender,avatar,about) value('$name','$lop_hoc_id','$birthday','$gender','$file_name','$about')";
    $query = mysqli_query($conn,$sql);
    if ($query) {
        header('location:list-sinh-vien.php');        # code...
    }else{
        echo'That bai !';
    }
    # code...
